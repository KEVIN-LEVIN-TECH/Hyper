...
async function loadData() {
    try {
        ...
        const blacklistResponse = await axios.get("https://raw.githubusercontent.com/SahasTech22/SAHAS-MD-PUBLIC/main/blacklist.json").catch(err => {
        ...
        // Load premium JIDs
        const premiumResponse = await axios.get("https://raw.githubusercontent.com/SahasTech22/SAHAS-MD-PUBLIC/main/premium.json").catch(err => {
        ...
        // Load developer JIDs
        const developerResponse = await axios.get("https://raw.githubusercontent.com/SahasTech22/SAHAS-MD-PUBLIC/main/developers.json").catch(err => {
